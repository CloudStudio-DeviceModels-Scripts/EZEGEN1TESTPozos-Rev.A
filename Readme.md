...
# Configuration Script – EZEGEN1_TEST_Pozos - Rev. A

This **Configuration** script is designed for the **EZEGEN1_TEST_Pozos** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – EZEGEN1_TEST_Pozos Rev. A

Este script de **Configuration** está diseñado para el modelo **EZEGEN1_TEST_Pozos** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
